...
// we have inserted Test ID that you can use while testing your App.
    ...
    private void showFileChooser() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Nude"), PICK_IMAGE_REQUEST);
    }
    ...
    private void uploadFile() {
        ...
        if (filePath != null) {
            ...
            Toast.makeText(getApplicationContext(), "No Nude Image chosen ", Toast.LENGTH_LONG).show();
        }
    }
